...
for(const s of ['zone===0','zone===1','else{'])if(!show.includes(s))throw Error('three-world showcase marker missing: '+s);
console.log('showcase structural smoke: PASS anti-stuck + browser guard + three-world graphics + detailed people');
